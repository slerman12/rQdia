...
from SPR_rQdia.src.models import SPRCatDqnModel
from SPR_rQdia.src.rlpyt_utils import OneToOneSerialEvalCollector, SerialSampler, MinibatchRlEvalWandb
from SPR_rQdia.src.algos import SPRCategoricalDQN
from SPR_rQdia.src.agent import SPRAgent
from SPR_rQdia.src.rlpyt_atari_env import AtariEnv
from SPR_rQdia.src.utils import set_config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rqdia', type=int, default=1)
